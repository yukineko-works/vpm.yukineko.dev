...
## v1.5.0
`2026/05/02`
- Feat: VRモードでクイックメニューを開く方法を追加
  - 「利き手側ではないコントローラーのトリガーを押しながら、利き手側のコントローラーのトリガーを素早く2回押して開く」ことができるようになりました
  - 従来の素早く2回押して開く方法が、VRChatのシステム側の機能と干渉してしまう問題を解消します
- Feat: デスクトップモードでクイックメニューを開く方法を追加
  - 新たに`Shift+Tab`で開けるようになりました
  - 一部の環境でペンと干渉してしまう問題を改善します
- Feat: モバイルからもクイックメニューを使用できるように
  - AndroidやiOSの、アプリ版VRChatからもクイックメニューを使用できるようになりました
  - 画面左上に表示されるメニューボタンから呼び出せます
- Chore: 依存関係を更新

## v1.4.1
`2026/02/19`
- Fix: ホームとメニュー下部のモジュール一覧をスクロールできない問題を修正
- Chore: ホームのモジュールタイルとメニュー下部のモジュール一覧のアイコンのデザインを調整
